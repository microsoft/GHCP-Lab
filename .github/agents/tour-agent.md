...
description: Specific code-tour building agent
---
...
- **Progressive Complexity**: Starting with simple completions and advancing to complex agent tasks
- **Feature Categories in this order**:
...
```jsonc
{
  "file": "src/[FileName].cs", // if it's a task within a specific file, include the file name. If it's a general remark, you may skip this.
